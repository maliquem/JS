...
*/
var nordeste = ['Ceará', 'Rio Grande do Norte', 'Pernambuco', 'Bahia', 'Alagoas', 'Maranhão', 'Piauí', 'Paraíba', 'Sergipe'];
...
var includes = brasil.includes('Ceará');
includes ? console.log('Ceará está incluído!') : console.log('Ceará não foi incluído :(');
...
*/
var par = map.filter(function(item){
    return item.id % 2 === 0;
})
