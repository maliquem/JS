...
var raissa = {
  ...
  */
  ...
  console.log(getFullName.call(jael));
  console.log(getFullName.call(raissa));
  ...
  */
  function sum(){
    ...
    return Array.prototype.reduce.call(arguments, function(soma, atual){
      return +soma + +atual;
    });
  }
  ...
  */
  ...
  console.log(sum(10,20,10,30,10));
