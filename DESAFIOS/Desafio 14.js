...
*/
var reducePInversed = nome.reduceRight(function(acumulado, atual){
    return acumulado + ('P' + atual);
}, '');
console.log( '\nInversed Name:', reducePInversed);
// ?
...
o que acontece ;)
*/
console.log( '\nExiste um { number: 2 } em numberObjects?', numberObjects.indexOf({number: 2}) );
